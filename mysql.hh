...
struct mysql_connection {
    ...
    mysql_connection(string db,string ip, unsigned int port);
    ~mysql_connection();
};

struct schema_mysql : schema, mysql_connection {
    schema_mysql(string db,string ip, unsigned int port);
...
struct dut_mysql : dut_base, mysql_connection {
    ...
    dut_mysql(string db,string ip, unsigned int port);
